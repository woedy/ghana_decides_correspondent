...
class UploadElectionResult extends StatefulWidget {
  final data;


  const UploadElectionResult({super.key,
    required this.data,
  ...
  @override
  State<UploadElectionResult> createState() => _UploadElectionResultState();
}

class _UploadElectionResultState extends State<UploadElectionResult> {
                          ...
                          children: [
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text("Upload Presidential Result", style: TextStyle(fontSize: 35, fontFamily: "Fontspring", height: 1 , fontWeight: FontWeight.w700),),
                                  SizedBox(
                                    height: 15,
                                  ),
