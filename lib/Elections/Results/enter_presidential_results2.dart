...
class EnterPresidentialResultScreen2 extends StatefulWidget {
  ...
  @override
  State<EnterPresidentialResultScreen2> createState() =>
      _EnterPresidentialResultScreen2State();
}

class _EnterPresidentialResultScreen2State extends State<EnterPresidentialResultScreen2> {
  List<TextEditingController> textControllers = [];
  GlobalKey<FormState> formKey = GlobalKey<FormState>();
  late Future<ElectionPresidentialCandidatesModel> _futureGetPresidentialCandidate;

  @override
  void initState() {
    super.initState();
    _futureGetPresidentialCandidate = get_election_presidential_candidates();
    _futureGetPresidentialCandidate.then((value) {
      var data = value.data;
      if (data != null) {
        setState(() {
    ...
    return FutureBuilder<ElectionPresidentialCandidatesModel>(
      ...
      builder: (context, snapshot) {
        if (snapshot.connectionState == ConnectionState.waiting) {
          ...
          var _presidentialCandidates = data.data;
                          ...
                          Expanded(
                            child: Form(
                              ...
                              child: ListView.builder(
                                itemCount: _presidentialCandidates!.length,
                                      ...
                                      children: [
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              image: NetworkImage(hostNameMedia +
                                                  _presidentialCandidates[index].candidate!.photo!
                                                      .toString()),
                                              fit: BoxFit.cover,
                                            ),
                                          ),
                                        ...
                                        Container(
                                          ...
                                          decoration: BoxDecoration(
                                            ...
                                            image: DecorationImage(
                                              image: NetworkImage(hostNameMedia +
                                                  _presidentialCandidates[index].candidate!.party!
                                                      .partyLogo!
                                                      .toString()),
                                              fit: BoxFit.cover,
                                            ),
                            ...
                            onTap: () async {
                              if (formKey.currentState!.validate()) {
                                ...
                                for (int i = 0; i < textControllers.length; i++) {
                                  results.add({
                                    'election_prez_id': _presidentialCandidates[i].electionPrezId.toString(),
                                ...
                                try {
                                  var response = await http.post(
                                    Uri.parse(hostName + "elections/add-presidential-vote/"),
                                    headers: <String, String>{
                                      'Content-Type': 'application/json; charset=UTF-8',
                                      'Accept': 'application/json',
                                      'Authorization': 'Token ' + "4487f5a04fbcbbc32a1bc71788a2142aff324a24"
